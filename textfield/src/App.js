    ...
    return (
      <div className="App">
        <form class="navbar-form" id="login">
            ...
            <CampoDeTexto Names={['email']} PlaceHolders={['Ingresa tu correo']} Types={['email']} pattern={["[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"]}/>
            <TextoExplicativo Texto={['Contraseña']}/>
            <CampoDeTexto Names={['password']} PlaceHolders={['Ingresa tu contraseña']} Types={['password']} pattern={[".{6,}"]}/>
